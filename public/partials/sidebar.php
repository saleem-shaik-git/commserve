...
<aside class="col-lg-2 sidebar p-3 bg-white border-end">
  <div class="d-lg-none mb-3">
    <div class="card hero-card border-0"><div class="card-body p-3 text-white"><div class="small text-white-50">Total Balance</div><div class="fw-bold fs-5">₦<?= number_format($totalBalance ?? 0, 2) ?></div></div></div>
  </div>
  ...
  <div class="card border-0 bg-light mt-4">
    <div class="card-body p-3">
      <div class="small fw-semibold"><i class="bi bi-info-circle me-1"></i> Demo Mode</div>
      <div class="small text-muted mt-1">All transactions are simulated. No real money moves.</div>
      <a href="/commserve/public/statements.php" class="btn btn-sm btn-outline-primary mt-2 w-100">Get Statement</a>
    </div>
  </div>
</aside>
