...
final class BankingService
{
    ...
    private function recalculateBalance(int $accountId):void{$this->db->prepare('UPDATE accounts SET available_balance=? WHERE id=?')->execute([$this->balance($accountId),$accountId]);}
